  ...
  return (
    <div className="w-full h-full bg-[#F9F1F0]">
      ...
      <div className="mt-10">
        ...
        <p className="text-center text-black  font-light text-base md:text-xl mt-2">A love story that began in the heart of a city, and blossomed into something truly special.</p>
      </div>
    </div>
  );
}
